...
export default function Page() {
  return (
    <div className="flex flex-col justify-center m-6">
      <div className="w-full p-8 tracking-wider text-2xl rounded-3xl bg-black/30 text-white">
        <p className="text-center">Welcome to my DASHBOARD!</p>
      </div>
      <div className="flex my-6 h-full gap-x-12">
        <div className="flex-1 p-6 leading-7 tracking-wider rounded-3xl bg-black/30 text-white">
        ...
        <div className="flex-1 p-6 rounded-3xl bg-black/30 text-white">
          <Image
      ...
      <div className="flex justify-center w-full p-8 tracking-wider text-2xl rounded-3xl bg-black/30">
        <Link
          href="/dashboard"
